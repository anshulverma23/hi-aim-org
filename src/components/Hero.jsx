  ...
  return (
    <section className="relative min-h-[100vh] flex items-center justify-center pt-24 pb-16 px-4 lg:px-8 overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div
          className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[rgba(99,129,168,0.1)] rounded-full blur-[100px] animate-pulse"
      ...
      <div className="relative z-20 max-w-6xl mx-auto w-full flex flex-col items-center text-center animate-slide-up">
        ...
        {/* CTA Buttons */}
        <div className="flex flex-col background-[0,0,0,0.4] sm:flex-row gap-4 sm:gap-6 justify-center w-full sm:w-auto">
          <Link
